...
tags: ["ethereum"]
image: "https://cdn.rexkirshner.com/blog/the-world-computer-banner.webp"
---

*Original Appearance: [Inevitable Ethereum](https://inevitableeth.com/ethereum/world-computer)*
...
Over the next ~500 years, the Europeans (and Americans) would build on this system until it eventually [collapsed in the 2008 Global Financial Crisis](https://inevitableeth.com/background/gfc).
...
One that is [credibly neutral](https://inevitableeth.com/concepts/credible-neutrality).
...
Fair computing built atop fair [settlement](https://inevitableeth.com/concepts/settlement), for anyone, at any time, forever.
...
A [block](https://inevitableeth.com/ethereum/block) is made up of 3 key components:

*   A record of the [transactions](https://inevitableeth.com/ethereum/transaction) executed at the time the block was created
*   A [signature](https://inevitableeth.com/concepts/digital-signatures), unique to each specific block
...
The method by which all these independent and untrusted computers keep their local copy of the EVM in sync is called a [consensus system](https://inevitableeth.com/ethereum/consensus).
...
From internet native property rights comes [internet native settlement](https://inevitableeth.com/ethereum/internet-settlement).
...
[Programmable Money](https://inevitableeth.com/ethereum/programmable-money). Decentralized Finance.
...
No one can tell you what the future holds, but the internet is [not the first time technology changed the way humans coordinate](https://inevitableeth.com/background/printing-press), and it will not be the last.
...
![](https://inevitableeth.com/images/world-computer-2.png)
...
The trilemma only makes sense if you think of Ethereum as a typical [computer](https://inevitableeth.com/background/computer), with a CPU and memory and the like.
...
As rollups improve execution, they will need to post an increasing amount transaction records; [Danksharding](https://inevitableeth.com/ethereum/data) will VASTLY increase capacity for these records.
...
![](https://inevitableeth.com/images/world-computer-3.png)
...
And [EigenLayer](https://inevitableeth.com/ethereum/eigenlayer) will allow ETH to extend its untrusted-trust property onto ANY application that requires a centralized (or otherwise trusted) actor.
...
![](https://inevitableeth.com/images/trustless-trust-1.jpeg)
